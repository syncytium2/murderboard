...
**What it costs.** Pasting this into a chat costs one conversation — the cheap way in, and not
the fan-out. The automated levels in [`START-HERE.md`](START-HERE.md) spawn one agent per role
and cost a great deal more; **known good there: Claude Opus 5**. Either way you pay for the
tokens, and we are not liable for any cost — ever. [`TERMS.md`](TERMS.md)
